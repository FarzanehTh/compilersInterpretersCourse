...
namespace minicc {
    ...
    public:
        ...
        void accept(ASTVisitor *visitor) override { // visitor is a ASTprinter here
            visitor->visitVarRef(this); // this here refer to the child node VarReferenec that I want to print, so here it says "print me"
        }
